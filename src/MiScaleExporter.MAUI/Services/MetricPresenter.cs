...
namespace MiScaleExporter.Services
{
    public class MetricPresenter : IMetricPresenter
    {
        ...
        private static string LabelFor(MetricKey key) => key switch
        {
            ...
            MetricKey.MuscleMass => "Estimated Lean Soft Mass",
            MetricKey.BoneMass => "Estimated Bone Mass",
            MetricKey.VisceralFat => "Visceral Fat Rating",
            MetricKey.BMR => "Basal Metabolism",
            MetricKey.MetabolicAge => "Estimated Metabolic Age",
